function search(){
  ...
  $.ajax({
        ...
        url: baseurl + "admin/search", // Isi dengan url/path file php yang dituju
    ...
    success: function(response){ // Ketika proses pengiriman berhasil
        ...
        $("#jenis_barang").val(response.jenis_barang); // set textbox dengan id telepon
        $("#waktu_temuan").val(response.waktu_temuan); // set textbox dengan id alamat
