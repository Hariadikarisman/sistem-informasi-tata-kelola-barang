  ...
  <div class="row mb-3">
    <div class="card m-auto" style="width: 550px;">
      <div class="card-header">
        <h4>ubah data temuana barang</h4>
      </div>

      <div class="card-body">
        <?php echo form_open_multipart('admin/ubahdatatemuan/'.$id); ?>
          <input type="hidden" name="id" value="<?= $temuan['id'] ?>">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="waktu_temuan" id="waktu_temuan" class="form-control" value="<?= $temuan['waktu_temuan']; ?>">
