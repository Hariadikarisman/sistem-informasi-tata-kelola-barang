        ...
        <?php echo form_open_multipart('kehilangan/buat'); ?>
          ...
          <div class="form-group">
            <h6 class="text">Select images:</h6><br> 
              <div class="custom-file">
                 <!-- <img for="gambar" id="gambar" name="gambar" class="rounded" width="150" src="<?= base_url('Asset/img/no-image.png')?> "> -->
          ...
          <div class="form-group">
            ...
            <small class="form-text text-danger"><?= form_error('tempat_kehilangan') ?></small>
             <p class="card-text"><small class="text-muted">** beri tanda ( - ) jika lupa tempat kehilangan</small></p>
          </div>
          ...
          <div class="form-group">
            ...
            <p class="card-text"><small class="text-muted">** beri tanda ( - ) jika lupa waktu kehilangan</small></p>
          </div>
