   ...
   <!--  <div class="col-lg-2 mb-3">
      ...
      <div class="menu1">
        <ul class="list-group" id="list-tab" role="tablist">
          ...
          <a href="<?php echo site_url(); ?>kehilanganpengguna/index/elektronik"><li class="list-group-item" style="text-decoration: none">Elektronik</li></a>
          <a href="<?php echo site_url(); ?>kehilanganpengguna/index/buku"><li class="list-group-item">Buku</li></a>
          <a href="<?php echo site_url(); ?>kehilanganpengguna/index/kartu"><li class="list-group-item">Kartu</li></a>
          <a href="<?php echo site_url(); ?>kehilanganpengguna/index/Lainnya"><li class="list-group-item">Lainnya</li></a>
        </ul>
      </div>
    </div> -->
