              ...
              <tbody>
                ...
                foreach ($data as $d) : ?>
                  <tr style="color: black">
                    ...
                    <td><?= $d['date_create']; ?></td>
                    <td>
                      <a href="<?= base_url('datatemuan/index/'. $d ['id'] ); ?> " class="badge badge-info"><i class="fas fa-info-circle" > Data user</i></a><br>
                      <a href="<?= base_url(); ?>datatemuan/hapus" class="badge badge-danger"><i class="far fa-trash-alt"> Hapus Akun</i></a>
