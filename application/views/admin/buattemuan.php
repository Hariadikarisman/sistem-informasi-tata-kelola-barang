  ...
  <div class="row mb-3">
    <div class="card m-auto " style="width:550px">
      ...
      <div class="card-header mb-10" >
        <h4>Masukan data Temuan barang</h4>
      </div>
      ...
      <div class="col-lg">
        <?php echo form_open_multipart('admin/buattemuan'); ?>
          <div class="form-group">
            <label class="text" for="nama">Nama Penemu Barang :</label><br>
          ...
          <div class="form-group">
            <label class="text" for="tempat_temuan">Tempat Temuan :</label><br>
            <input type="text" name="tempat_temuan" id="tempat_temuan" class="form-control">
            <small class="form-text text-danger"><?= form_error('tempat_temuan') ?></small>
          </div>

          <div class="form-group">
            <label class="text" for="waktu_temuan">Waktu Temuan :</label><br>
            <input type="text" name="waktu_temuan" id="waktu_temuan" class="form-control">
          ...
          <div class="form-group">
            ...
            <small>** nomor admin (untuk dihubungi pemilik barang)</small>
          </div>
