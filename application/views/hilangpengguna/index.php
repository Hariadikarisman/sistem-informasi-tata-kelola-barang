    ...
    <div class="col-lg-2 mb-3">
      <div class="menu1">
        <ul class="list-group" id="list-tab" role="tablist">
          ...
          <a href="<?php echo site_url(); ?>hilangpengguna/index/elektronik" class="text-decoration-none"><li class="list-group-item">Elektronik<span class="badge badge-info float-right"></span></li></a>
          <a href="<?php echo site_url(); ?>hilangpengguna/index/buku" class="text-decoration-none"><li class="list-group-item">Buku<span class="badge badge-info float-right"></span></li></a>
          <a href="<?php echo site_url(); ?>hilangpengguna/index/kartu" class="text-decoration-none"><li class="list-group-item">Kartu<span class="badge badge-info float-right"></span></li></a>
          <a href="<?php echo site_url(); ?>hilangpengguna/index/Lainnya" class="text-decoration-none"><li class="list-group-item">Lainnya<span class="badge badge-info float-right"></span></li></a>
        </ul>
      </div>
    </div>
    ...
    <div class="table col-lg-10 ">
      <div class="mb-5">
          ...
          <div class="list-group">
            <li class="list-group-item active" style="text-align: center"><h3>Laporan Barang Hilang " <?= ucfirst($jenis) ?> "</h3>
                ...
                <div class="media">
                  ...
                  <div class="col-lg-10">
                    ...
                    <a href="<?php echo base_url('hilangpengguna/hapus/'. $hilang['id']. '/'. $jenis);  ?>" onclick="return confirm('yakin hapus data ?');">
                      ...
                      <p class="text-monospace text-right mt-4">Status : <?php echo $hilang['peran']; ?></p>
                      <p class="text-monospace text-right">Waktu Hilang : <?php echo $hilang['waktu_kehilangan']; ?></p>
                    </div>
                  </div>
                  <div class="col-lg-2">
