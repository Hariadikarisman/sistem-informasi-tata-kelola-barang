      ...
      <input type="checkbox" id="menu">
        <div class="menu1">
          <ul class="list-group" id="list-tab" role="tablist">
            ...
            <a href="<?php echo site_url('datatemuan/index/'.$user['id'].'/elektronik'); ?>"><li class="list-group-item" style="text-decoration: none">Elektronik<span class="badge badge-info float-right"></span></li></a>
            <a href="<?php echo site_url('datatemuan/index/'.$user['id'].'/buku'); ?>"><li class="list-group-item">Buku<span class="badge badge-info float-right"></span></li></a>
            <a href="<?php echo site_url('datatemuan/index/'.$user['id'].'/kartu'); ?>"><li class="list-group-item">Kartu<span class="badge badge-info float-right"></span></li></a>
            <a href="<?php echo site_url('datatemuan/index/'.$user['id'].'/Lainnya'); ?>"><li class="list-group-item">Lainnya<span class="badge badge-info float-right"></span></li></a>
          </ul>
        </div>
    </div>
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <div class="list-group ">
            ...
            <?php $i=1; foreach ($tabeltemuan as $temuan) : ?>
              <?php if($temuan['selesai'] == 1 || $temuan['tahunan'] == 1) {
                ...
                <div class="media">
                  ...
                  <div class="col-lg-2">
                    <a href="<?= base_url('Asset/img/temuan/') . $temuan['gambar']?>">
                      <img class="rounded" width="100" class="img-profile" src="<?= base_url('Asset/img/temuan/') . $temuan['gambar']?> ">
                    </a>
                  </div>
                  ...
                  <div class="col-lg-10">
                      ...
                      <a href="" id="edit-done" data-toggle="modal" data-target="#done<?= $temuan['id']; ?>" data-id="<?= $temuan['id'] ?>">
                        <?php if($temuan['selesai'] == 1){
                          echo'<span class="badge badge-sm badge-success mt-1 mb-1" disabled> <i class="fas fa-check-circle"></i> Selesai </span>';
                            ...
                            echo'<span class="badge badge-sm badge-warning mt-1 mb-1"> <i class="fas fa-minus-circle"></i> Sudah 1 tahun </span>';
                          } else {
                    ...
                    <a href="<?php echo base_url('datatemuan/hapus/'. $user['id']. '/'. $jenis .'/'. $temuan['id']);  ?>" onclick="return confirm('yakin hapus data ?');">
                      ...
                      <h6 class="font-italic text-right"><?php echo $temuan['waktu_temuan']; ?></h6>
                    </div>
                  </div>
                  </div>
                  </div>
    ...
    <div class="modal-dialog  modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Detail Informasi Barang Temuan</h5>
        ...
        <div id="modal-edit" class="modal-body">
            <div class="form-group">
              <label for="nama" class="col-form-label">Nama Penemu</label>
