              ...
              <table class="table" id="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url();?>temuan/index/elektronik">
                          <button class="btn btn-sm btn-warning"><span class="fa fa-plus mr-3" style="color:white"></span><span class="fa fa-eye" style="color:white"></span></button>
                      </a>
                    </td>
                  </tr>
                </tbody>
              ...
              <table class="table" id="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url();?>kehilangan/index/elektronik">
                        <button class="btn btn-sm btn-warning"><span class="fa fa-plus mr-3" style="color:white"></span><span class="fa fa-eye" style="color:white"></span></button>
                      </a>
                    </td>
                  </tr>
