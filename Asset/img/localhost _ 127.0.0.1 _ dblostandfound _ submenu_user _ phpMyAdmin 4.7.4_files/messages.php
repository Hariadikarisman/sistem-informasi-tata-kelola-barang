...
PMA_messages['strMysqlAllowedValuesTipTime'] = "MySQL menerima nilai tambahan yang tidak dapat terpilih oleh slider; kunci di nilai-nilai ini secara langsung jika diinginkan";
...
PMA_messages['strConsoleDebugError'] = "Terjadi beberapa kesalahan saat mendapatkan informasi debug dari SQL.";
PMA_messages['strConsoleDebugSummary'] = "%s kueri tereksekusi %s kali dalam waktu %s detik.";
PMA_messages['strConsoleDebugArgsSummary'] = "%s argumen lolos";
PMA_messages['strConsoleDebugShowArgs'] = "Tampilkan argumen";
PMA_messages['strConsoleDebugHideArgs'] = "Sembunyikan argumen";
PMA_messages['strConsoleDebugTimeTaken'] = "Waktu yang dipakai:";
PMA_messages['strNoLocalStorage'] = "Ada masalah saat mengakses penyimpanan browser Anda, beberapa fitur mungkin tidak bekerja dengan baik untuk Anda. Sangat mungkin bahwa browser tidak mendukung penyimpanan atau batas kuota telah tercapai. Pada Firefox, penyimpanan yang rusak juga dapat menyebabkan masalah seperti itu, membersihkan \"Data Situs Luring\" anda, mungkin bisa memperbaiki hal ini. Di Safari, masalah tersebut umumnya disebabkan oleh \"Mode Penjelajahan Pribadi\".";
